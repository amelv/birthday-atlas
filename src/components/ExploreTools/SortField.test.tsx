...
describe('SortField component', () => {
  it('should render the sort dropdown and button', () => {
    render(<SortField />, { providerProps: { value: [
        { exploreSettings: { sort: { by: SortOption.DEFAULT, order: SortOrder.DESC } } },
        mockDispatch
      ] } });

    expect(screen.getByLabelText('Sort By:')).toBeInTheDocument();
    expect(screen.getByRole('button', { name: 'Default sort' })).toBeInTheDocument();
  });
